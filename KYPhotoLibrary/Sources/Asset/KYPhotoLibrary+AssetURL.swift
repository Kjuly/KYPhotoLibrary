...
extension KYPhotoLibrary {
  ...
  ///
  /// When "`scheme = .library`" (e.g., "assets-library://asset/filename.MP4?id=A45B74E5-003F-49CA-A7DB-FA978A29966C"),
  ...
  public static func assetURL(
    ...
    //}
    let filename: String = (assetResource.originalFilename.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed)
